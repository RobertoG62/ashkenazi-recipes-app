    ...
    function updateStaticText() {
        ...
        if (heroTitle) {
            heroTitle.innerHTML = i18n.getLanguage() === 'he' ?
                'המטבח <span class="text-as-primary-light">האשכנזי</span>' :
                '<span class="text-as-primary-light">Ashkenazi</span> Cuisine';
        }
        ...
        if (footerText) {
            footerText.innerHTML = i18n.t('footer.tagline') + ' <span class="text-as-primary-light mx-1"><i class="fas fa-heart"></i></span>';
        }
